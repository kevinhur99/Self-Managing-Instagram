...
username = 'kezin99@gmail.com'
password = 'jeong99Lego@'
...
if download == True:
    ...
    L.load_session_from_file('C:\\Users\\Kevin\\AppData\\Local\\Instaloader\\session-kezin99')
...
hashtags = ['#dankmemes', '#cringelord', '#lol', '#lmao', '#dank', '#funnymemes', '#memesdaily',
            ...
            '#anime', '#hilarious', '#comedy', '#nichememes', '#jokes', '#memedealer', '#politics'
                                                                                       '#edgymemes', '#edgy',
            '#offensivememes', '#offensive', '#edit', '#weird', '#weirdmemes',
